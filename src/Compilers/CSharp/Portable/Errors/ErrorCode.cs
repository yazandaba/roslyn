...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal enum ErrorCode
    {
        ...
        ERR_BadConstevalItem = 9379,
        ERR_NoConstevalGenericMethod = 9380,
        ERR_NoConstevalConstructor = 9381,
        ERR_NoConstevalDestructor = 9382,
        ERR_ConstevalParameterMustBePrimitive = 9383,
        ERR_ConstevalReturnTypeMustBePrimitive = 9384,
        ERR_ConstevalParameterCannotBeRefOutIn = 9385,
        ERR_ConstevalParameterCannotBeParams = 9386,
        ERR_ConstevalParameterCannotBeDynamic = 9387,
        ERR_ConstevalReturnTypeCannotBeDynamic = 9388,
        ERR_ConstevalFunctionCannotBeAsync = 9389,
        ERR_ConstevalFunctionCannotBeUnsafe = 9390,
        ERR_ConstevalFunctionCannotBeGeneric = 9391,
        ERR_ConstevalLocalMustBePrimitive = 9392,
        ERR_ConstevalCannotReferenceGenericType = 9393,
        ERR_ConstevalCanOnlyAccessConstFields = 9394,
        ERR_ConstevalCannotUseNewExpression = 9395,
        ERR_ConstevalCannotUseTryCatchFinally = 9396,
        ERR_ConstevalCannotUseThrow = 9397,
        ERR_ConstevalUnsupportedControlFlow = 9398,
        ERR_ConstevalCanOnlyCallConsteval = 9399,
        ERR_ConstevalCannotUseUserDefinedOperator = 9400,
        ERR_ConstevalCannotUseTypeOf = 9401,
        ERR_ConstevalCannotUseSizeOf = 9402,
        ERR_ConstevalHasNoBody = 9403,
        ERR_ConstevalCannotBeExtern = 9404,
        ERR_ConstevalCannotBePartial = 9405,
        ERR_ConstevalCannotHavePolymorphicModifiers = 9406,
        ERR_ConstevalRecursionDepthExceeded = 9407,
        ERR_ConstevalLoopIterationLimitExceeded = 9408,
        ERR_ConstevalDivisionByZero = 9409,
        ERR_ConstevalOverflow = 9410,
        ERR_ConstevalEvaluationFailed = 9411,
        ERR_ConstevalSwitchPatternNotAllowed = 9412
